...
\subsubsection{Instancja Asymetryczna }
            ...
            \begin{figure}[H]
                ...
                \\ \includegraphics[scale=0.6]{images/lenght_asym.png}\
            ...
            \begin{figure}[H]
                ...
                \\ \includegraphics[scale=0.6]{images/time_asym.png}\
...
\subsubsection{Instancja Euklidesowa }
            ...
            \begin{figure}[H]
                ...
                \\ \includegraphics[scale=0.6]{images/lenght_euc.png}\
            ...
            \begin{figure}[H]
                ...
                \\ \includegraphics[scale=0.6]{images/time_euc.png}\
...
\subsubsection{Instancja startowa dla 2-opt }
            ...
            \begin{figure}[H]
                ...
                \\ \includegraphics[scale=0.6]{images/att48_to_start.png}\
...
\subsubsection{Instancja zwrócona przez 2-opt }
            ...
            \begin{figure}[H]
                ...
                \\ \includegraphics[scale=0.6]{images/att48_to-sol.png}\
...
\subsubsection{Instancja zwrócona przez 2-opt }
            \begin{center}
            \begin{figure}[H]
                \\ \includegraphics[scale=0.6]{images/att48_opt-sol.png}\
            \end{figure}
            \end{center}
\subsubsection{Pórównanie długości ścieżek}
            \begin{center}
            \begin{figure}[H]
                \\ \includegraphics[scale=0.8]{images/att48.png}\
            \end{figure}
            \end{center}
